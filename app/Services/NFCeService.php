...
class NFCeService{
	...
	private function enableLegacyOpenSSL(){
    try{
        ...
        Log::warning('Falha ao configurar OPENSSL legacy (NFCeService)', [
	...
	public function __construct($config, $emitente){
        ...
        $this->tools = new Tools(json_encode($config), $this->readCertificate($emitente));
