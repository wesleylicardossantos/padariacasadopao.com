...
class EcommerceController extends Controller
{
	...
	public function atualizaItem(Request $request)
	{
		...
		try {
			$item = ItemPedidoEcommerce::find($id);
	...
	private function calculaFreteNormal($request)
	{
		...
		$config = ConfigEcommerce::where('empresa_id', $pedido->empresa_id)
		->first();
	...
	public function setaFrete(Request $request)
	{
		...
		try {
			...
			$pedido->valor_frete = __convert_value_bd($valor);
	...
	private function calculaFreteEnderecos($endereco, $carrinho)
	{
		...
		$config = ConfigEcommerce::where('empresa_id', $carrinho->empresa_id)
		->first();
