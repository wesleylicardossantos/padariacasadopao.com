...
Route::middleware('restrictMaintenance')->get('/clear-all', function(){
    ...
    return response()->json([
        'success' => true,
        'message' => 'Caches limpos com segurança.',
    ]);
});
...
Route::get('/branding/{empresa}/{type}', 'BrandingAssetController@show')
    ->where(['empresa' => '[0-9]+', 'type' => 'logo|background'])
    ->name('branding.asset');



Route::get('/enterprise-center', 'EnterpriseCentroController@index')->name('enterprise.center');
Route::group(['prefix' => 'portal'], function () {
    ...
    Route::group(['middleware' => 'portalFuncionario'], function () {
        ...
        Route::get('/dossie', 'RHPortalFuncionarioController@dossieExterno')->name('rh.portal_externo.dossie');
        Route::get('/documentos-rescisao', 'RHPortalFuncionarioController@documentosRescisaoExterno')->name('rh.portal_externo.documentos_rescisao');
        Route::get('/documentos-rescisao/{id}/trct.pdf', 'RHDocumentoGeradoController@trctPdf')->name('rh.portal_externo.documentos_rescisao.trct.pdf');
        Route::get('/documentos-rescisao/{id}/tqrct.pdf', 'RHDocumentoGeradoController@tqrctPdf')->name('rh.portal_externo.documentos_rescisao.tqrct.pdf');
        Route::get('/documentos-rescisao/{id}/homologacao.pdf', 'RHDocumentoGeradoController@homologacaoPdf')->name('rh.portal_externo.documentos_rescisao.homologacao.pdf');
    });
});
...
Route::middleware([
    ...
    Route::group(['prefix' => '/controle'], function () {
        Route::get('/paes', function () {
            return view('controle.paes')
                ->with('title', 'Controle de Pães')
                ->with('rotaAtiva', 'Controle');
        })->name('controle.paes');

        Route::get('/salgados', 'ControleSalgadoController@index')->name('controle.salgados.index');
        Route::get('/salgados/create', 'ControleSalgadoController@create')->name('controle.salgados.create');
        Route::post('/salgados', 'ControleSalgadoController@store')->name('controle.salgados.store');
        Route::get('/salgados/{id}', 'ControleSalgadoController@show')->name('controle.salgados.show');
        Route::get('/salgados/{id}/edit', 'ControleSalgadoController@edit')->name('controle.salgados.edit');
        Route::put('/salgados/{id}', 'ControleSalgadoController@update')->name('controle.salgados.update');
        Route::delete('/salgados/{id}', 'ControleSalgadoController@destroy')->name('controle.salgados.destroy');
        Route::get('/salgados/{id}/pdf', 'ControleSalgadoController@pdf')->name('controle.salgados.pdf');
    });


    Route::group(['prefix' => '/precificacao'], function () {
        Route::get('/', 'PrecificacaoController@index')->name('precificacao.index');
        Route::post('/implantar-kit-padaria', 'PrecificacaoController@instalarKitPadaria')->name('precificacao.kit-padaria.instalar');
        Route::get('/insumos', 'PrecificacaoInsumoController@index')->name('precificacao.insumos.index');
        Route::get('/fichas-tecnicas', 'PrecificacaoReceitaController@index')->name('precificacao.receitas.index');
        Route::get('/fichas-tecnicas/criar', 'PrecificacaoReceitaController@create')->name('precificacao.receitas.create');
        Route::post('/fichas-tecnicas', 'PrecificacaoReceitaController@store')->name('precificacao.receitas.store');
        Route::get('/fichas-tecnicas/{id}/editar', 'PrecificacaoReceitaController@edit')->name('precificacao.receitas.edit');
        Route::put('/fichas-tecnicas/{id}', 'PrecificacaoReceitaController@update')->name('precificacao.receitas.update');
        Route::post('/fichas-tecnicas/{id}/duplicar', 'PrecificacaoReceitaController@duplicate')->name('precificacao.receitas.duplicate');
        Route::delete('/fichas-tecnicas/{id}', 'PrecificacaoReceitaController@destroy')->name('precificacao.receitas.destroy');
        Route::get('/exemplos', 'PrecificacaoExemploController@index')->name('precificacao.exemplos.index');
        Route::get('/mapeamentos', 'PrecificacaoMapeamentoController@index')->name('precificacao.mapeamentos.index');
        Route::get('/sugestoes', 'PrecificacaoSugestaoController@index')->name('precificacao.sugestoes.index');
        Route::post('/sugestoes/{id}/aprovar', 'PrecificacaoSugestaoController@aprovar')->name('precificacao.sugestoes.aprovar');
        Route::get('/dashboard-executivo', 'PrecificacaoDashboardExecutivoController@index')->name('precificacao.dashboard-executivo.index');
        Route::get('/canais', 'PrecificacaoCanalController@index')->name('precificacao.canais.index');
        Route::get('/lista-compras', 'PrecificacaoListaCompraController@index')->name('precificacao.lista-compras.index');
        Route::get('/producao', 'PrecificacaoProducaoController@index')->name('precificacao.producao.index');
    });
...
/* RH - Dashboard Executivo migrado para app/Modules/RH/Routes/web.php */
...
|--------------------------------------------------------------------------
*/
// RH migrado para app/Modules/RH/Routes/web.php
// Bloco legado removido para evitar duplicidade de rotas.
...
Route::group(['prefix' => 'pdv-offline', 'middleware' => ['tenant.context', 'verificaEmpresa', 'validaAcesso', 'verificaContratoAssinado', 'limiteArmazenamento']], function () {
    Route::get('/monitor', 'Pdv\\OfflineSyncMonitorController@index')->name('pdv.offline.monitor');
    Route::get('/monitor/dados', 'Pdv\\OfflineSyncMonitorController@data')->name('pdv.offline.monitor.data');
    Route::post('/monitor/reenviar-pendentes', 'Pdv\\OfflineSyncMonitorController@reenviarPendentes')->name('pdv.offline.monitor.reenviar_pendentes');
    Route::post('/monitor/reenviar-erros', 'Pdv\\OfflineSyncMonitorController@reenviarErros')->name('pdv.offline.monitor.reenviar_erros');
});
