								...
								<div class="row">
									...
									<div class="col-lg-4 col-12">
										...
										<div class="checkout__input">
											...
											<input class="form-control cpf_cnpj" value="{{ old('docNumber') }}" id="docNumber" data-checkout="docNumber" name="docNumber" type="tel">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-12">
										...
										<div class="checkout__input">
											...
											<input class="form-control cpf_cnpj" value="{{ old('docNumber') ? old('docNumber') : $cliente->cpf  }}" id="docNumber" data-checkout="docNumber" name="docNumber" type="tel">
											@if($errors->has('docNumber'))
											<label class="text-danger">{{ $errors->first('docNumber') }}</label>
											@endif
										</div>
