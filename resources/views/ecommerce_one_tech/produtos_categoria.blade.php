					...
					<div class="shop_content">
						...
						<div class="product_grid">
							...
							<div class="product_item is_new">
								...
								<a href="{{$rota}}/{{$p->id}}/verProduto"><div class="product_image d-flex flex-column align-items-center justify-content-center"><img class="img-prod" src="{{$p->galeria[0]->img}}" alt=""></div>
								</a>
						...
						<input type="hidden" id="max" value="{{$max}}" name="">
