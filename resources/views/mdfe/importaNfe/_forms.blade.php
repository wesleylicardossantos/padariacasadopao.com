<div class="row g-3">
    ...
    @endif
    <h5>Dados iniciais com importação Nfe</h5>
    <hr>
    <div class="col-md-2">
        {!! Form::select('uf_inicio', 'UF inicial', ['' => 'Selecione...'] + App\Models\Mdfe::cUF())->attrs([
        'class' => 'select2',
        ])->required() !!}
    </div>
    <div class="col-md-2">
        {!! Form::select('uf_fim', 'UF final', ['' => 'Selecione...'] + App\Models\Mdfe::cUF())->attrs([
        'class' => 'select2',
        ])->required() !!}
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-2">
        {!! Form::text('lac_rodo', 'Lacre rodoviário')->attrs(['class' => ''])->required() !!}
    </div>
    <div class="col-md-3">
