...
<head>
    ...
    <title>{{ $brandingNome }} Login</title>
</head>
        ...
        <div class="row g-0 min-vh-100">
            <div class="col-lg-5 col-12 auth-left-wrapper">
                ...
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="/">
                            <!-- CAMINHO DA LOGO: public{{ $brandingLogo }} -->
                    ...
                    <div class="auth-card mt-4">
                        <form method="post" action="{{ route('login.request') }}" id="form-login">
                            ...
                            <div class="form-group position-relative mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="login" placeholder="Digite seu usuário" autofocus @if(session('login') !=null) value="{{ session('login') }}" @else @if(isset($loginCookie)) value="{{$loginCookie}}" @endif @endif name="login" />
                            </div>

                            <div class="form-group position-relative mb-3">
                                <label class="form-label" for="senha">Senha</label>
                                <input type="password" class="form-control" id="senha" name="senha" placeholder="Digite sua senha" autocomplete="off" @if(isset($senhaCookie)) value="{{$senhaCookie}}" @endif>
                            </div>

                            <div class="form-check form-check-lg d-flex mt-1 mb-3">
                                <input class="form-check-input me-2" type="checkbox" id="lembrar" name="lembrar" @isset($lembrarCookie) @if($lembrarCookie==true) checked @endif @endisset />
            ...
            <div class="col-lg-7 col-12 d-none d-lg-block">
                ...
                <div id="auth-right" style="background: linear-gradient(135deg, rgba(21,31,65,0.78), rgba(63,84,145,0.42)), url('{{ $brandingBackground }}') center center / cover no-repeat;">
