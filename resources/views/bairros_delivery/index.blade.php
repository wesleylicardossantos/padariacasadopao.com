    ...
    <div class="card ">
        <div class="card-body p-4">
            <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
                <div class="ms-auto">
                    <a href="{{ route('bairrosDelivery.create') }}" type="button" class="btn btn-success">
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-left ">
                        ...
                        <a id="clear-filter" class="btn btn-danger" href="{{ route('bairrosDelivery.index') }}"><i class="bx bx-eraser"></i> Limpar</a>
                    </div>
                </div>
                {!! Form::close() !!}
                <hr />
                            ...
                            <table class="table mb-0 table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('bairrosDelivery.destroy', $item->id) }}" method="post" id="form-{{ $item->id }}">
                                                @method('delete')
                                                <a href="{{ route('bairrosDelivery.edit', $item) }}" class="btn btn-warning btn-sm text-white">
