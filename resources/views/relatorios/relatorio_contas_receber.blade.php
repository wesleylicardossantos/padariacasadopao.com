...
<body>
	...
	<thead>
		<tr>
			...
			<th width="10%" class="text-left">Valor Iintegral</th>
	...
	<tbody>
		...
		<tr style="font-size:12px;">
			...
			<td class="text-left">{{ $c->cliente ? $c->cliente->razao_social : ($c->venda ? $c->venda->cliente->razao_social : 'Não Identificado') }}</td>
			...
			<td class="text-left">{{ number_format($c->valor_recebido, 2, ',', '.') }}</td>
