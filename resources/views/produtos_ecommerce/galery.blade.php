@extends('default.layout',['title' => 'Galeria Produto Ecommerce'])
@section('content')
<div class="page-content">
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body p-5">
            ...
            {!!Form::open()
            ->post()
            ->route('produtoEcommerce.saveImagem')
            ->multipart()!!}
            <div class="m-5">
                ...
                <div id="image-preview" class="col-md-4">
                    ...
                    @isset($item)
                    @if ($item->imagem)
                    <img src="/uploads/produtoEcommerce/{{ $item->imagem }}" class="img-default">
                    @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="card card-custom gutter mt-2">
                                ...
                                <img style="width: auto; height: 200px;" class="m-2" src="/uploads/produtoEcommerce/{{$g->path}}">
                                @else
                                <img style="width: auto; height: 200px;" class="m-2" src="/imgs/no_image.png" alt="image">
                                @endif
                                <a onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/produtoEcommerce/deleteImagem/{{$g->id}}" }else{return false} })' href="#!" class="btn btn-danger m-2">
