            ...
            <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
                <div class="ms-auto">
                    <a href="{{ route('servicos.create')}}" type="button" class="btn btn-success">
                        <i class="bx bx-plus"></i> Novo serviço
                    </a>
                </div>
            </div>
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-left ">
                        ...
                        <a id="clear-filter" class="btn btn-danger" href="{{ route('servicos.index') }}"><i class="bx bx-eraser"></i>Limpar</a>
                    </div>
                </div>
                {!!Form::close()!!}
                <hr />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('servicos.destroy', $item->id) }}" method="post" id="form-{{$item->id}}">
                                                @method('delete')
                                                <a href="{{ route('servicos.edit', $item) }}" class="btn btn-warning btn-sm text-white">
