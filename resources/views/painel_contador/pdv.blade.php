                ...
                <div class="card mt-3">
                    <div class="card-body">
                            ...
                            <table class="table mb-0 table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->chave }}</td>
                                        <td>{{ $item->numero_nfce }}</td>
                                        <td>{{ $item->created_at }}</td>
                                        <td>
                                            @if($item->estado_emissao == 'aprovado')
                                            <a title="Download XML" class="btn btn-sm btn-light" href="{{ route('contador.pdv-download-xml', $item->id) }}">
                        ...
                        <div class="mt-3">
                            ...
                            <form method="get" action="{{ route('contador.download-xml-nfce') }}">
