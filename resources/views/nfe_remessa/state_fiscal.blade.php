@extends('default.layout',['title' => 'Alterar estado fiscal nfe remessa'])
@section('content')
	...
	<div class="card border-top border-0 border-4 border-primary">
		<div class="card-body p-5">
			<div class="page-breadcrumb d-sm-flex align-items-center mb-3">
				<div class="ms-auto">
					<a href="{{ route('nferemessa.index')}}" type="button" class="btn btn-light btn-sm">
						<i class="bx bx-arrow-back"></i> Voltar
					</a>
				</div>
			</div>
			<div class="card-title d-flex align-items-center">
				<h5 class="mb-0 text-primary">Alterar estado fiscal nfe remessa</h5>
			</div>
			<div class="card">
				<div class="card-body">
			...
			{!!Form::open()
			->put()
			->route('nferemessa.update-state', [$item->id])
			->multipart()!!}
			<div class="pl-lg-4">
				<div class="row g-3">
					<div class="col-md-3">
