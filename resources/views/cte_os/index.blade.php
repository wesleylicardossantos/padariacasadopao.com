@extends('default.layout',['title' => 'Lista de CTe Os'])
@section('content')
    ...
    <div class="card ">
        <div class="card-body p-4">
            <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
                <div class="ms-auto">
                    <a href="{{ route('cteOs.create')}}" type="button" class="btn btn-success">
                        <i class="bx bx-plus"></i> Nova CTe Os
                    </a>
                </div>
            </div>
            <hr>
            <div class="col">
                <h6 class="mb-0 text-uppercase mt-4">LISTA DE CTe Os</h6>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table mb-0 table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" style="z-index: 999">
                                                    <form action="{{ route('cteOs.destroy', $item->id) }}" method="post" id="form-{{$item->id}}">
                                                        @method('delete')
                                                        @csrf
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('cteOs.edit', $item) }}">Editar</a>
                                                        </li>
                                                        <li>
                                                            <button type="button" class="dropdown-item btn-delete">Remover</button>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('cteOs.detalhes', $item->id) }}" id="info">Detalhes</a>
                                                        </li>
                                                        {{-- <li>
                                                            <a class="dropdown-item" href="{{ route('cteOs.custos', $item->id) }}">Custos</a>
                                                        </li> --}}
                                                        {{-- <li>
                                        ...
                                        <td>{{ $item->emitente->razao_social }}</td>
                                        <td>{{ $item->tomador_cli->razao_social }}</td>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-2">
                                <button id="btn-enviar" type="button" class="btn btn-success spinner-white spinner-right px-2"  style="width: 100%">Transmitir</button>
                            </div>
                            <div class="col-md-2">
                            ...
                            {{-- e-mail --}}
                            <div class="col-md-2">
                                <button id="btn-enviar-email" type="button" data-bs-toggle="modal" data-bs-target="#modal-emailCteOs" class="btn btn-primary spinner-white btn-action spinner-right" style="width: 100%">Enviar E-mail</button>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <button id="btn-xml-temp" type="button" class="btn btn-outline-secondary spinner-white spinner-right" style="width: 100%">XML Temporário</button>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        ->attrs(['class' => 'form-select'])
                        ->options(App\Models\CteOs::gruposCte()) !!}
                    </div>
                    <div class="col-md-6">
...
@include('modals._emailCteOs', ['not_submit' => true])

@endsection

@section('js')
<script src="/js/cteOs.js"></script>
@endsection
