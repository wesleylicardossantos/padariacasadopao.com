                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    ...
                                    <input data-mask="(00) 00000-0000" value="{{old('telefone')}}" name="telefone" type="tel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="checkout__input">
                                    ...
                                    <input id="doc" value="{{old('cpf')}}" data-mask="000.000.000-00" data-mask-reverse="true" name="cpf" type="tel">
                                    @if($errors->has('cpf'))
                            ...
                            <div class="col-lg-5 ie" style="display: none;">
                                <div class="checkout__input">
                                    <p>IE<span>*</span></p>
                                    <input id="doc" value="{{old('ie')}}" name="ie" type="tel">
                                    @if($errors->has('ie'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="checkout__input">
                                    <p>CEP<span>*</span></p>
                                    <input data-mask="00000-000" data-mask-reverse="true" value="{{{ $default['carrinho']->observacao != '' ? $default['carrinho']->observacao : old('cep') }}}" name="cep" type="tel">
                                    @if($errors->has('cep'))
