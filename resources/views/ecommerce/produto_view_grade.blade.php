		...
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<div class="product__details__pic">
					<div class="product__details__pic__item">
						<img class="product__details__pic__item--large"src="/ecommerce/produtos/{{$produto->galeria[0]->img}}" alt="">
					</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="product__details__text">
					...
					<div class="row">
						<span class="ml-3">Selecione uma opção</span>
						<div class="col-12">
							<select class="sel w-75 mt-1">
