...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			if(isMultiple){
				dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Arraste e solte seu(s) arquivo(s) aqui para fazer o upload</span><button type="button"class="btn btn-default">ou selecione para upload</button></div></div>`);
			}else{
				dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><button type="button"class="btn btn-default">Selecione uma imagem para upload</button></div></div>`);
			}
			...
			console.log("retrieveFiles", retrieveFiles)
			const readingFile = (id, file) => {
				const fReader = new FileReader();
				const width = dragbox.width();
				const boxesNb = Math.floor(width / 100);
