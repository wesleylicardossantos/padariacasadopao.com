...
<div class="page-content">
    <div class="card card-custom gutter-b">
        <div class="card-body">
            <?php if(empresaComFilial() && sizeof(getLocaisUsarioLogado()) > 0): ?>
            <div class="row">
                <?php echo __view_locais_select_home(); ?>
...
.pdv-status.critico{background:#fee2e2;color:#991b1b;}
            ...
            <div class="row <?php if(env('ANIMACAO')): ?> animate__animated <?php endif; ?> animate__backInRight mt-3 g-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <h5 class="kpi-value total_vendas">R$ <?php echo e(__moeda(0)); ?></h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <h5 class="kpi-value total_vendas_mes">R$ <?php echo e(__moeda(0)); ?></h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <h5 class="kpi-value total_vendas_hoje">R$ <?php echo e(__moeda(0)); ?></h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <h5 class="kpi-value total_receber">R$ <?php echo e(__moeda(0)); ?></h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <h5 class="kpi-value total_pagar">R$ <?php echo e(__moeda(0)); ?></h5>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <h5 class="kpi-value total_ticket_medio">R$ <?php echo e(__moeda(0)); ?></h5>
            ...
            <div class="row <?php if(env('ANIMACAO')): ?> animate__animated <?php endif; ?> animate__bounce">
                <div class="">
...
<?php echo $__env->make('default.layout', ['title' => 'Gráficos'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/wesl4494/public_html/padariacasadopao.com/resources/views/default/grafico.blade.php ENDPATH**/ ?>