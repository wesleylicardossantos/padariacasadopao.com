...
<div class="page-content rh-dashboard">
            ...
            <div class="hero-grid">
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-3">
                        <span class="hero-chip"><?php echo e($ativos); ?> ativos</span>
                        <span class="hero-chip"><?php echo e($inativos); ?> inativos</span>
                        <span class="hero-chip">Competência <?php echo e($competenciaLabel); ?></span>
                        <span class="hero-chip">Turnover <?php echo e(number_format($turnover,2,',','.')); ?>%</span>
                        <?php if($ultimaCompetencia): ?>
                            <span class="hero-chip">Última apuração <?php echo e($ultimaCompetencia); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="d-flex flex-wrap gap-2 mt-3 rh-toolbar">
                        <a href="<?php echo e(route('rh.folha.processamento.index')); ?>" class="btn btn-light text-dark"><i class="bx bx-calculator"></i> Processar folha</a>
                        <a href="<?php echo e(route('apuracaoMensal.holerites_competencia')); ?>" class="btn btn-outline-light"><i class="bx bx-receipt"></i> Holerites</a>
                        <a href="<?php echo e(route('rh.portal_funcionario.index')); ?>" class="btn btn-outline-light"><i class="bx bx-user-circle"></i> Portal</a>
                ...
                <div class="hero-panel mt-3">
                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-4">
                            <div class="big"><?php echo e($totalFuncionarios); ?></div>
                            <div class="muted">colaboradores no quadro total</div>
                        </div>
                        <div class="col-md-4">
                            <div class="big">R$ <?php echo e(number_format($folhaMensal,2,',','.')); ?></div>
                            <div class="muted">base salarial ativa da empresa</div>
                        </div>
                        <div class="col-md-4">
                            <div class="big"><?php echo e($alertasCount); ?></div>
                ...
                <div>
                    <div class="rh-filter-card mb-3">
                        <form method="GET" action="<?php echo e(url('/rh')); ?>" class="row g-2 align-items-end">
                            <div class="col-6">
                                <label>Competência</label>
                                <select name="mes" class="form-select">
                                    <?php for($mesOpcao = 1; $mesOpcao <= 12; $mesOpcao++): ?>
                                        <option value="<?php echo e($mesOpcao); ?>" <?php if($mesSelecionado === $mesOpcao): echo 'selected'; endif; ?>><?php echo e(str_pad($mesOpcao,2,'0',STR_PAD_LEFT)); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            <div class="col-6">
                                ...
                                <select name="ano" class="form-select">
                                    <?php $__currentLoopData = $anosFiltro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anoOpcao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($anoOpcao); ?>" <?php if($anoSelecionado === $anoOpcao): echo 'selected'; endif; ?>><?php echo e($anoOpcao); ?></option>
                    ...
                    <div class="hero-metric-grid">
                        <div class="hero-metric">
                            ...
                            <div class="sub"><?php echo e($folhaProcessadaNoMes ? 'Folha processada com dados reais.' : 'Sem apuração final, usando base disponível.'); ?></div>
                        </div>
                        <div class="hero-metric">
                            <div class="label">Folha líquida</div>
                            <div class="value">R$ <?php echo e(number_format($liquidoMes,2,',','.')); ?></div>
                            <div class="sub">Proventos R$ <?php echo e(number_format($totalProventosMes,2,',','.')); ?> · Descontos R$ <?php echo e(number_format($totalDescontosMes,2,',','.')); ?></div>
                        </div>
                        <div class="hero-metric">
                            <div class="label">Alertas e férias</div>
                            <div class="value"><?php echo e($alertasCount + $feriasPendentes); ?></div>
                            <div class="sub"><?php echo e($alertasCount); ?> alertas críticos · <?php echo e($feriasPendentes); ?> férias pendentes</div>
                        </div>
                        <div class="hero-metric">
                            <div class="label">Saúde da folha</div>
                            <div class="value"><?php echo e(number_format($saudeFolha,2,',','.')); ?>%</div>
    ...
    <div class="row g-3 mb-3 mt-1">
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Tendência da folha</div><div class="rh-stat-value"><?php echo e($variacaoFolhaPercentual > 0 ? '+' : ''); ?><?php echo e(number_format($variacaoFolhaPercentual,2,',','.')); ?>%</div><div class="rh-stat-sub">Comparação do líquido com a competência anterior</div><div class="rh-stat-meta"><span class="rh-kpi-trend <?php echo e($variacaoFolhaPercentual > 0 ? 'rh-kpi-up' : ($variacaoFolhaPercentual < 0 ? 'rh-kpi-down' : 'rh-kpi-flat')); ?>"><?php echo e($folhaAnteriorSerie ? 'vs. ' . ($folhaAnteriorSerie['competencia'] ?? 'anterior') : 'Sem histórico'); ?></span></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Tendência do headcount</div><div class="rh-stat-value"><?php echo e($variacaoHeadcountPainel > 0 ? '+' : ''); ?><?php echo e($variacaoHeadcountPainel); ?></div><div class="rh-stat-sub">Diferença de ativos contra a competência anterior</div><div class="rh-stat-meta"><span class="rh-kpi-trend <?php echo e($variacaoHeadcountPainel > 0 ? 'rh-kpi-up' : ($variacaoHeadcountPainel < 0 ? 'rh-kpi-down' : 'rh-kpi-flat')); ?>"><?php echo e($headcountAnteriorSerie ? 'Ativos ' . ($headcountAnteriorSerie['label'] ?? 'anterior') : 'Sem histórico'); ?></span></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Tendência do absenteísmo</div><div class="rh-stat-value"><?php echo e($variacaoAbsenteismo > 0 ? '+' : ''); ?><?php echo e($variacaoAbsenteismo); ?></div><div class="rh-stat-sub">Faltas + atrasos + atestados versus mês anterior</div><div class="rh-stat-meta"><span class="rh-kpi-trend <?php echo e($variacaoAbsenteismo < 0 ? 'rh-kpi-up' : ($variacaoAbsenteismo > 0 ? 'rh-kpi-down' : 'rh-kpi-flat')); ?>">Atual <?php echo e($absenteismoAtualTotal); ?> · anterior <?php echo e($absenteismoAnteriorTotal); ?></span></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Movimento líquido</div><div class="rh-stat-value"><?php echo e($movimentoLiquido > 0 ? '+' : ''); ?><?php echo e($movimentoLiquido); ?></div><div class="rh-stat-sub">Saldo entre admissões e desligamentos</div><div class="rh-stat-meta"><span class="rh-kpi-trend <?php echo e($movimentoLiquido > 0 ? 'rh-kpi-up' : ($movimentoLiquido < 0 ? 'rh-kpi-down' : 'rh-kpi-flat')); ?>">Variação <?php echo e($variacaoMovimento > 0 ? '+' : ''); ?><?php echo e($variacaoMovimento); ?></span></div></div></div></div>
    </div>

    <div class="row g-3 mb-1">
        <div class="col-xl-3 col-md-6"><div class="card rh-card rh-stat-card"><div class="card-body"><div class="rh-stat-label">Quadro total</div><div class="rh-stat-value"><?php echo e($totalFuncionarios); ?></div><div class="rh-stat-sub">Colaboradores cadastrados</div><div class="rh-stat-meta"><span class="rh-badge rh-badge-primary"><?php echo e(number_format($percentualAtivos,2,',','.')); ?>% ativos</span><span class="rh-badge <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card rh-stat-card"><div class="card-body"><div class="rh-stat-label">Folha mensal</div><div class="rh-stat-value">R$ <?php echo e(number_format($folhaMensal,2,',','.')); ?></div><div class="rh-stat-sub">Base salarial ativa</div><div class="rh-stat-meta"><span class="rh-badge rh-badge-dark">Médio por colaborador: R$ <?php echo e(number_format($custoMedioColaborador,2,',','.')); ?></span></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card rh-stat-card"><div class="card-body"><div class="rh-stat-label">Líquido da competência</div><div class="rh-stat-value">R$ <?php echo e(number_format($liquidoMes,2,',','.')); ?></div><div class="rh-stat-sub">Total líquido apurado em <?php echo e($competenciaLabel); ?></div><div class="rh-stat-meta"><span class="rh-badge rh-badge-success">Ticket médio: R$ <?php echo e(number_format($ticketMedioFolha,2,',','.')); ?></span></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card rh-stat-card"><div class="card-body"><div class="rh-stat-label">Absenteísmo</div><div class="rh-stat-value"><?php echo e($faltasMes); ?> / <?php echo e($atrasosMes); ?></div><div class="rh-stat-sub">Faltas e atrasos da competência</div><div class="rh-stat-meta"><span class="rh-badge rh-badge-warning"><?php echo e($atestadosMes); ?> atestados</span></div></div></div></div>
    </div>

    <div class="row g-3 mb-1">
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Admissões</div><div class="rh-stat-value"><?php echo e($admissoesMes); ?></div><div class="rh-stat-sub">Entradas em <?php echo e($competenciaLabel); ?></div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Desligamentos</div><div class="rh-stat-value"><?php echo e($desligamentosMes); ?></div><div class="rh-stat-sub">Saídas registradas na competência</div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Movimentações</div><div class="rh-stat-value"><?php echo e($movimentacoesMes); ?></div><div class="rh-stat-sub">Promoções, ajustes e eventos no período</div></div></div></div>
        <div class="col-xl-3 col-md-6"><div class="card rh-card"><div class="card-body"><div class="rh-stat-label">Variação do headcount</div><div class="rh-stat-value"><?php echo e($variacaoHeadcount > 0 ? '+' : ''); ?><?php echo e($variacaoHeadcount); ?></div><div class="rh-stat-sub">Saldo entre admissões e desligamentos</div></div></div></div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card rh-card">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <span class="rh-badge rh-badge-dark">Turnover <?php echo e(number_format($turnover,2,',','.')); ?>%</span>
                </div>
        ...
        <div class="col-lg-4" id="ia-empresa-painel">
            <div class="card rh-card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="rh-badge <?php echo e($alertas->count() > 0 ? 'rh-badge-warning' : 'rh-badge-success'); ?>"><?php echo e($alertas->count()); ?></span>
                </div>
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $alertas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="rh-list-row">
                            <div>
                                <div class="fw-bold"><?php echo e($item['funcionario'] ?? 'Funcionário'); ?></div>
                                <div class="rh-mini"><?php echo e($item['tipo'] ?? 'Alerta'); ?> — <?php echo e($item['descricao'] ?? ''); ?></div>
                            </div>
                            <div class="text-end"><span class="rh-badge <?php echo e($badgeClass); ?>"><?php echo e($item['dias']); ?> dias</span></div>
                        </div>
        ...
        <div class="col-lg-7">
            <div class="card rh-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="rh-badge rh-badge-primary"><?php echo e($serieFolha->count()); ?> períodos</span>
                </div>
        ...
        <div class="col-lg-5">
            <div class="card rh-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="rh-badge rh-badge-dark"><?php echo e($totalFuncionarios); ?> no cadastro</span>
                </div>
        ...
        <div class="col-lg-6">
            <div class="card rh-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="rh-badge rh-badge-dark"><?php echo e($topSalarios->count()); ?> colaboradores</span>
                </div>
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $topSalarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colaborador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="rh-list-row">
                            <div>
                                <div class="fw-bold"><?php echo e($colaborador->nome); ?></div>
                                <div class="rh-mini"><?php echo e($colaborador->funcao ?: ($colaborador->cargo ?: 'Sem função definida')); ?></div>
                            </div>
                            <div class="text-end"><strong>R$ <?php echo e(number_format((float) $colaborador->salario,2,',','.')); ?></strong></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover rh-table mb-0">
                            ...
                            <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $feriasProximas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $status = strtolower((string) $item->status); ?>
                                <tr>
                                    <td><?php echo e(optional($item->funcionario)->nome ?: '-'); ?></td>
                                    <td><?php echo e($item->data_inicio ? \Carbon\Carbon::parse($item->data_inicio)->format('d/m/Y') : '-'); ?></td>
                                    <td><?php echo e($item->data_fim ? \Carbon\Carbon::parse($item->data_fim)->format('d/m/Y') : '-'); ?></td>
                                    <td><span class="rh-badge <?php echo e($status === 'pendente' ? 'rh-badge-warning' : ($status === 'gozo' ? 'rh-badge-success' : 'rh-badge-primary')); ?>"><?php echo e(ucfirst($item->status)); ?></span></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover rh-table mb-0">
                            ...
                            <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $movimentacoesRecentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($item->data_movimentacao ? \Carbon\Carbon::parse($item->data_movimentacao)->format('d/m/Y') : '-'); ?></td>
                                    <td><?php echo e(optional($item->funcionario)->nome ?: '-'); ?></td>
                                    <td><?php echo e(\App\Models\RHMovimentacao::tipos()[$item->tipo] ?? ucfirst((string) $item->tipo)); ?></td>
...
(function () {
    ...
    if (fluxoCanvas) {
        new Chart(fluxoCanvas, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($graficoMeses ?? [], 15, 512) ?>,
                datasets: [
                    {
                        label: 'Admissões',
                        data: <?php echo json_encode($graficoAdmissoes ?? [], 15, 512) ?>,
                        borderRadius: 8,
                        borderSkipped: false,
                    ...
                    {
                        label: 'Desligamentos',
                        data: <?php echo json_encode($graficoDesligamentos ?? [], 15, 512) ?>,
                        borderRadius: 8,
                        borderSkipped: false,
    ...
    if (folhaCanvas) {
        const serieFolha = <?php echo json_encode($serieFolha->values()->all(), 15, 512) ?>;
    ...
    if (headcountCanvas) {
        const serie = <?php echo json_encode($serieHeadcount->values()->all(), 15, 512) ?>;
...
<?php echo $__env->make('default.layout',['title' => 'Dashboard RH Executivo'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/wesl4494/public_html/padariacasadopao.com/resources/views/rh/dashboard.blade.php ENDPATH**/ ?>