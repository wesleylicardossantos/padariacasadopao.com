<div class="row g-3">
    <div class="col-md-6">
        <?php echo Form::text('natureza', 'Descrição')
    ...
    <div class="col-md-3">
        <?php echo Form::select('sobrescreve_cfop', 'Sobrescrever CFOP do produto', [0 => 'Não', 1 => 'Sim'])
    ...
    <div class="col-md-3">
        <?php echo Form::select('finNFe', 'Finalidade da NFe', App\Models\NaturezaOperacao::finalidades())
        ->attrs(['class' => 'form-select']); ?>

    </div>

    <div class="col-md-2">
        <?php echo Form::text('CFOP_saida_estadual', 'CFOP de saída estadual')
    ...
    <div class="col-md-2">
        <?php echo Form::text('CFOP_saida_inter_estadual', 'CFOP de saída outro estado')
        ->attrs(['class' => 'form-control cfop'])
        ->required(); ?>
    ...
    <div class="col-md-2">
        <?php echo Form::text('CFOP_entrada_estadual', 'CFOP de entrada estadual')
        ->attrs(['class' => 'form-control cfop'])
        ->required(); ?>
    ...
    <div class="col-md-2">
        <?php echo Form::text('CFOP_entrada_inter_estadual', 'CFOP de entrada outro estado')
        ->attrs(['class' => 'form-control cfop'])
        ->required(); ?>
...
<?php /**PATH /home2/wesl4494/public_html/padariacasadopao.com/resources/views/naturezas/_forms.blade.php ENDPATH**/ ?>