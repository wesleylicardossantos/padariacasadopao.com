    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo Form::tel('cpf_cnpj', 'CPF/CNPJ')->attrs(['class' => 'cpf_cnpj']); ?>

                    </div>
                    <div class="col-md-12 mt-3">
                        <?php echo Form::text('nome', 'Nome (opcional)')->attrs(['class' => '']); ?>
...
<?php /**PATH /home2/wesl4494/public_html/padariacasadopao.com/resources/views/modals/frontBox/_cpf_nota.blade.php ENDPATH**/ ?>